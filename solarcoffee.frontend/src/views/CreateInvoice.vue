    ...
    <div class="invoice-step" v-if="invoiceStep === 1">
     ...
     <div class="invoice-step" v-if="invoiceStep===2">
         ...
         <div class="invoice-item-actions">
             <solar-button :disable="!newItem.product || !newItem.quantity" @button:click="addLineItem">Add Line Item</solar-button>
             <solar-button :disable="!lineItems.length" @button:click="finalizeOrder">Finalize Order</solar-button>
         </div>
      ...
      <div class="invoice-step" v-if="invoiceStep===3">
          ...
          <div class="invoice-step-detail" id="invoice" ref="invoice">
              <div class="invoice-logo">
                  <img id="imgLogo" alt="Solar Coffee logo" src="../assets/images/coffeeLogo.png">
                  <h3>1337 Lane Street</h3>
                  <h3>San Francisco, CA 90000</h3>
                  <h3>USA</h3>
...
// noinsperction TypeScriptCheckImport
...
downloadPdf(){
         ...
         let height = this.$refs.invoice.clientHeith;

html2canvas(invoice)
        .then(canvas=>{
             let image=canvas.toDataURL("image/png");
             pdf.addImage(image, 'PNG', 0, 0, 590,462);
             pdf.save('invoice');
        });
}
 addLineItem(){
